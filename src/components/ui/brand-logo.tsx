...
export function BrandLogo({
  ...
  return (
    <div
      className={`relative overflow-hidden rounded-[22px] bg-[linear-gradient(160deg,rgba(13,19,27,0.96),rgba(9,12,18,0.88))] shadow-[0_24px_54px_rgba(4,8,14,0.48)] ${className}`}
    >
